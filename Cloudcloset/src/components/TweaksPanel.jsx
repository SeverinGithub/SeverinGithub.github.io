// Floating Tweaks panel — a small control surface for app-wide preferences
// (theme, item display mode) and quick screen shortcuts. Draggable by its
// header. Light-themed regardless of app theme, since it is tool chrome.
...
export default function TweaksPanel({ open, onClose, title = 'Tweaks', children }) {
